...
Config.tty.execute_command = "/bin/zsh --login -i";
Config.tty.title = "ck";
...
Config.window.cols = 65;
Config.window.rows = 18;
...
Config.window.transparent     = 0xF0;
...
Config.window.color_cursor        = 0xFFFFFF;
Config.window.color_imecursor     = 0xFF8294;
